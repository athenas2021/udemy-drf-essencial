...
# Caminho para pasta dos arquivos estáticos
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # 'rest_framework.authentication.SessionAuthentication', # Defino a autenticação para requisições na API como autenticação por sessão
